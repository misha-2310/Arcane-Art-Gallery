    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © 2021 - Arcane Art Gallery | <a href="http://localhost/Arcane_Art_Gallery/Arcane_Art_Gallery/index.php?page=home" target="_blank">Arcane Art</a></div></div>
        </footer>
